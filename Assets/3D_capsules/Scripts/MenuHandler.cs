    ...
    public class MenuHandler : MonoBehaviour
{
    ...
    public void HostGame()
    {
        ...
        if (deterministicSettingsQuery.TryGetSingletonEntity<DeterministicSettings>(out Entity deterministicSettings))
        {
            ...
            serverEntityManager.SetComponentData(serverDeterministicSettings, entityManager.GetComponentData<DeterministicSettings>(deterministicSettings));
            ...
            serverEntityManager.SetComponentEnabled<DeterministicServerRunSimulation>(serverDeterministicSettings, false);
            ...
            clientEntityManager.SetComponentData(clientDeterministicSettings, entityManager.GetComponentData<DeterministicSettings>(deterministicSettings));
            ...
            clientEntityManager.SetComponentEnabled<DeterministicClientSendData>(clientDeterministicSettings, false);
        }
        else
        {
            Debug.LogError("No DeterministicSettings entity found in the world. Make sure you have a DeterministicSettings entity in your world.");
        }
