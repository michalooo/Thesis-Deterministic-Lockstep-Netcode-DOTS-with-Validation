...
% It may be better (for example) to show a huge scale RTS demo using your lockstep, and a very lightweight fighting game using your rollback model. --> Discusse what I'm actually delivering
